...
USER_PERSONA = pd.read_csv("v1_hashtag/uselection_user_personas_40.csv")
IO_PERSONA = pd.read_csv("v1_hashtag/uselection_influence_personas_repub_10.csv") # change this file
