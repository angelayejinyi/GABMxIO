...
USER_PERSONA = pd.read_csv("v3_collective_decision_making/uselection_user_personas_40.csv")
IO_PERSONA = pd.read_csv("v3_collective_decision_making/uselection_influence_personas_repub_10.csv")
