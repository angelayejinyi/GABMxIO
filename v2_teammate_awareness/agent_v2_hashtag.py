...
USER_PERSONA = pd.read_csv("v2_teammate_awareness/uselection_user_personas_40.csv")
IO_PERSONA = pd.read_csv("v2_teammate_awareness/uselection_influence_personas_repub_10.csv")
